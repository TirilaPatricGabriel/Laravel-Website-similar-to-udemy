<template>
    <div class="w-screen flex items-center justify-center bg-[#408ec6] text-white">
        <form @submit.prevent="logIn" class="flex flex-col items-center justify-center border-2 px-64 py-40 rounded-md bg-[#6883bc]">
            ...
            <button type="submit" class="border-2 rounded-md py-1 px-6 mt-6 hover:bg-[#1e2761]">Log In</button>
        </form>
    </div>
</template>
